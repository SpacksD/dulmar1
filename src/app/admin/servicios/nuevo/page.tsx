...
export default function NuevoServicioPage() {
  ...
  const uploadImageForService = async (serviceId: number): Promise<string | null> => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (imageFile) {
          const imageUrl = await uploadImageForService(serviceId);
          if (!imageUrl) {
            alert('Servicio creado pero la imagen no pudo subirse');
          }
        }
        ...
        throw new Error(data.error || 'Error creating service');
      }
    } catch (error) {
      ...
      <div className="mb-6">
        <div className="flex items-center mb-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Crear un nuevo servicio para el centro infantil</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm">
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="space-y-4">
              {!imagePreview ? (
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                  ...
                  <p className="text-gray-600 mb-2">Selecciona una imagen para el servicio</p>
          ...
          <div className="flex justify-end space-x-4 pt-6 border-t border-gray-200">
            ...
            >
              {loading ? 'Creando...' : uploadingImage ? 'Subiendo imagen...' : 'Crear Servicio'}
            </button>
          </div>
        </form>
      </div>
